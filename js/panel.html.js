<div class="games-section">
  <span class="games-section-title">Игры</span>
  <div class="games-header-wrapper">
    <div class="games-header">
      ...
      <a class="header-button games-header-button base-gradient-border" href="ipc.html" rel="nofollow, noopener, noreferrer" target="_blank">
        <img class="header-button-content" alt="telegram" height="16" src="https://cdn.jsdelivr.net/gh/sherrienatonabah/vavada-online-casino@main/img/Hearth.svg" title="telegram"
          width="16">
      </a>
    </div>
